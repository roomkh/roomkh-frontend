    ...
    <div className="bg-gray-50 min-h-screen py-8 px-4 sm:px-6 lg:px-12 font-sans">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="text-xs text-gray-500">
          <span>{t('propertyDetail.breadcrumbHome')}</span> &gt; <span className="font-semibold text-gray-800">{t('about.breadcrumb')}</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 mb-2">{t('about.missionTitle')}</h2>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 mb-2">{t('about.visionTitle')}</h2>
              <p className="text-xs text-gray-500 leading-relaxed">
                {t('about.visionDesc')}
              </p>
            </div>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900">{t('about.valuesTitle')}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-blue-50/60 border border-blue-100/60 p-6 rounded-2xl text-center space-y-3">
              ...
              <h3 className="font-bold text-sm text-gray-900">{t('about.trust')}</h3>
            ...
            <div className="bg-blue-50/60 border border-blue-100/60 p-6 rounded-2xl text-center space-y-3">
              ...
              <h3 className="font-bold text-sm text-gray-900">{t('about.integrity')}</h3>
              <p className="text-[11px] text-gray-500 leading-relaxed">
            ...
            <div className="bg-blue-50/60 border border-blue-100/60 p-6 rounded-2xl text-center space-y-3">
              ...
              <h3 className="font-bold text-sm text-gray-900">{t('about.innovation')}</h3>
              <p className="text-[11px] text-gray-500 leading-relaxed">
            ...
            <div className="bg-blue-50/60 border border-blue-100/60 p-6 rounded-2xl text-center space-y-3">
              ...
              <h3 className="font-bold text-sm text-gray-900">{t('about.customerFirst')}</h3>
              <p className="text-[11px] text-gray-500 leading-relaxed">
        ...
        {/* Our Service Section */}
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900">{t('about.serviceTitle')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-900 mb-1">{t('about.buyProperty')}</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  {t('about.buyPropertyDesc')}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-900 mb-1">{t('about.rentProperty')}</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  {t('about.rentPropertyDesc')}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-900 mb-1">{t('about.sellProperty')}</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  {t('about.sellPropertyDesc')}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center pt-4">
          ...
          <div className="md:col-span-8 space-y-3">
            <h2 className="text-xl font-bold text-gray-900">{t('about.storyTitle')}</h2>
