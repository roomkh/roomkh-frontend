...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serverMsg = err.response?.data?.message || err.message || 'Failed to create account. Please try again.';
        ...
        <div className="relative z-10 max-w-lg space-y-8 my-auto py-12">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight">
              ...
              <span className="text-blue-600">journey with us.</span>
            </h1>
            <p className="text-sm text-gray-500 leading-relaxed">
              Create an account to save properties, contact owners directly, or submit a request to sell and rent your own space.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">Save &amp; Compare Listings</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  Bookmark your favorite rooms and apartments to access them anytime.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">Direct Owner Contact</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  Connect instantly via Telegram, phone, or WhatsApp without middleman fees.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">Verified Marketplace</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  Safe and authenticated listings across Phnom Penh and major Cambodian cities.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 shadow-2xl space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Fill in your details to register with RoomKH
            </p>
          </div>
