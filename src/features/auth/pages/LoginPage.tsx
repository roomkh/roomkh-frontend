...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const serverMsg = e.response?.data?.message || e.message || 'Invalid email or password. Please try again.';
  ...
  return (
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-12 font-sans bg-white">
      ...
      <div className="hidden lg:flex lg:col-span-7 relative bg-gray-50 flex-col justify-between p-12 overflow-hidden border-r border-gray-100">
        <div 
          className="absolute inset-0 z-0 bg-cover bg-center opacity-60 filter grayscale"
          style={{
        ...
        <div className="relative z-10 max-w-lg space-y-8 my-auto py-12">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight">
              ...
              <span className="text-blue-600">{t('login.heroTitleAccent')}</span>
            </h1>
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">{t('login.feature1Title')}</h3>
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">{t('login.feature2Title')}</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">{t('login.feature3Title')}</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
