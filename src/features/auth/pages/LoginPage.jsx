        ...
        <div className="relative z-10 max-w-lg space-y-8 my-auto py-12">
          <div className="space-y-4">
            <span className="inline-block bg-blue-100/70 text-blue-700 text-[11px] font-bold px-3 py-1 rounded-full">
              Find. Rent. Better Living.
            </span>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight">
              Your complete property portal. <br />
              <span className="text-blue-600">Simplified.</span>
            </h1>
            <p className="text-sm text-gray-500 leading-relaxed">
              One unified platform for seekers to find homes, and teams to manage operations seamlessly.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">Smart Property Search</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  Browse, filter, and secure verified listings across Cambodia instantly.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">Landlord &amp; Agent Tools</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  List properties, manage premium boosts, and track incoming leads.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-xs text-gray-800">Secure Portal Access</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  Role-based encryption ensuring safe management for users and staff alike.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 shadow-2xl space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Sign in to access your RoomKH account
            </p>
          </div>
