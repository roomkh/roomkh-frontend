...
const NAV_ITEMS = [
  ...
  { to: '/seller/listings', icon: Home, label: 'My Listings' },
  { to: '/seller/add-property', icon: PlusCircle, label: 'Add Property' },
];
...
export default function SellerSidebar() {
  ...
  const displayName = user?.full_name || user?.fullName || user?.name || 'Seller';
      ...
      <div className="h-full flex flex-col justify-between">
        <div>
          ...
          <div className="h-16 flex items-center px-4 border-b border-slate-100">
            ...
            >
              <div className="w-10 h-10 rounded-2xl bg-blue-50 border border-blue-100/80 flex items-center justify-center text-blue-600 shrink-0 shadow-2xs">
        ...
        <div>
          ...
          <div className="p-3 border-t border-slate-100 bg-slate-50/50">
            ...
            >
              <div className="w-9 h-9 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold shrink-0 shadow-2xs">
