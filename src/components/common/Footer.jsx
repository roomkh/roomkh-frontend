    ...
    <footer className="bg-[#0066cc] text-white pt-12 pb-6 px-6 md:px-12 text-xs font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 pb-10 border-b border-blue-400/40">
          ...
          <div className="sm:col-span-2 md:col-span-1 space-y-4 ">
            ...
            <p className="text-blue-100/90 text-[11px] leading-relaxed max-w-xs">
              Cambodia's trusted property marketplace connecting buyers, renters, sellers, and property owners.
            </p>
          ...
          <div className="space-y-3">
            <h4 className="font-bold uppercase tracking-wider text-white text-xs">Explore</h4>
            <ul className="space-y-2 text-blue-100/80 text-[11px]">
              ...
              <li><Link to="/sell" className="hover:text-white transition">Sell</Link></li>
              <li><Link to="/location" className="hover:text-white transition">Location</Link></li>
            </ul>
          </div>

          {/* Column 3: Company */}
          <div className="space-y-3">
            <h4 className="font-bold uppercase tracking-wider text-white text-xs">Company</h4>
            <ul className="space-y-2 text-blue-100/80 text-[11px]">
          ...
          {/* Column 4: Support */}
          <div className="space-y-3">
            <h4 className="font-bold uppercase tracking-wider text-white text-xs">Support</h4>
            <ul className="space-y-2 text-blue-100/80 text-[11px]">
              <li><Link to="/help" className="hover:text-white transition">Help Center</Link></li>
              <li><Link to="/faqs" className="hover:text-white transition">FAQs</Link></li>
              <li><Link to="/terms" className="hover:text-white transition">Term &amp; Condition</Link></li>
          ...
          {/* Column 5: Contact */}
          <div className="space-y-3">
            <h4 className="font-bold uppercase tracking-wider text-white text-xs">Contact</h4>
        ...
        <div className="pt-5 flex flex-col sm:flex-row justify-between items-center text-blue-100/80 text-[11px] gap-2">
          <p>© 2026 RoomKH. All Rights Reserved.</p>
          <p className="flex items-center gap-1">
            Made with <Heart className="w-3.5 h-3.5 text-red-500 fill-red-500 inline" /> in Cambodia
          </p>
        </div>
      </div>
    </footer>
