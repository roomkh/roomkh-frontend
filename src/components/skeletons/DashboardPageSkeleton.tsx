    ...
    <div className="space-y-6 antialiased font-sans text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1.5">
          ...
          <div className="h-3 skeleton rounded-md w-72" />
        </div>
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="h-8 skeleton rounded-lg w-28" />
            </div>
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200/80 rounded-xl p-6 shadow-2xs">
          <div className="flex justify-between items-start mb-6">
            <div className="space-y-2">
              ...
              <div className="h-3 skeleton rounded-md w-60" />
            </div>
          ...
          <div className="w-full h-52 bg-slate-50/80 rounded-xl border border-slate-100 flex items-center justify-center">
            <div className="w-full h-40 mx-6 skeleton rounded-lg" />
          </div>
        </div>

        <div className="bg-white border border-slate-200/80 rounded-xl p-6 shadow-2xs">
          <div className="space-y-2 mb-6">
            <div className="h-4 skeleton rounded-md w-44" />
            <div className="h-3 skeleton rounded-md w-36" />
          </div>
      ...
      <div className="bg-white border border-slate-200/80 rounded-xl shadow-2xs overflow-hidden">
        <div className="p-5 border-b border-slate-100 flex items-center justify-between">
          <div className="space-y-1.5">
            <div className="h-5 skeleton rounded-md w-36" />
            <div className="h-3 skeleton rounded-md w-56" />
          </div>
