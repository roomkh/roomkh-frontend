    ...
    <div className="space-y-6 antialiased font-sans text-slate-800">
      ...
      <div className="bg-white border border-slate-200/80 rounded-xl shadow-2xs overflow-hidden">
        ...
        <div className="p-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-100">
          {/* Search Input */}
          <div className="flex-1 md:w-72 h-9 skeleton rounded-lg" />
        ...
        <div className="overflow-x-auto">
          <div className="p-4 space-y-4">
            ...
            <div className="flex items-center gap-4 pb-2 border-b border-slate-100">
              ...
              <div className="h-3 skeleton rounded w-20 w-48 shrink-0" />
              <div className="h-3 skeleton rounded w-32 shrink-0" />
              ...
              <div className="h-3 skeleton rounded w-20 shrink-0" />
              <div className="h-3 skeleton rounded w-16 shrink-0" />
              <div className="h-3 skeleton rounded w-12 ml-auto shrink-0" />
            </div>
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex items-center gap-4 py-2">
                ...
                {/* Properties Count */}
                <div className="h-4 skeleton rounded-md w-12 shrink-0" />
                ...
                {/* Action Menu Button */}
                <div className="w-8 h-8 rounded-lg skeleton ml-auto shrink-0" />
              </div>
            ))}
          </div>
        </div>
