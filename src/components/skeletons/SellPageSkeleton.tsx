      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white p-6 sm:p-10 rounded-2xl border border-gray-100 shadow-sm">
          <div className="lg:col-span-7 space-y-4">
            <div className="h-8 sm:h-10 skeleton rounded-md w-3/4" />
            <div className="h-4 skeleton rounded-md w-full" />
            <div className="h-24 skeleton rounded-lg w-full" />
          </div>
          <div className="lg:col-span-5 h-64 skeleton rounded-xl" />
        </div>

        <div>
          <div className="h-6 skeleton rounded-md w-48 mb-6" />
        ...
        <div>
          <div className="h-6 skeleton rounded-md w-32 mb-8" />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-4">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex flex-col items-center text-center space-y-3">
                ...
                <div className="h-4 skeleton rounded-md w-2/3" />
                <div className="h-3 skeleton rounded-md w-full max-w-[200px]" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-8 bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm space-y-6">
            <div className="h-6 skeleton rounded-md w-1/2" />
            ...
            <div className="space-y-2">
              <div className="h-3 skeleton rounded-md w-48" />
              ...
              <div className="space-y-3">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="flex items-start gap-2">
                    <div className="w-4 h-4 skeleton rounded-full flex-shrink-0 mt-0.5" />
                    <div className="h-3 skeleton rounded-md w-full" />
                  </div>
                ))}
              </div>
