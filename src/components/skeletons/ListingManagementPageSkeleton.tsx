        ...
        <div className="overflow-x-auto">
          <div className="p-4 space-y-4">
            ...
            <div className="flex items-center gap-4 pb-2 border-b border-slate-100">
              ...
              <div className="h-3 skeleton rounded w-20 ml-12" />
              <div className="h-3 skeleton rounded w-16 ml-16" />
              <div className="h-3 skeleton rounded w-20 ml-16" />
              <div className="h-3 skeleton rounded w-16 ml-16" />
              <div className="h-3 skeleton rounded w-16 ml-16" />
              <div className="h-3 skeleton rounded w-12 ml-auto" />
            </div>
              ...
              <div key={i} className="flex items-center gap-4 py-2">
                ...
                <div className="flex items-center space-x-2 w-40 shrink-0">
                  ...
                  <div className="space-y-1 flex-1">
                    <div className="h-3 skeleton rounded-md w-24" />
                    <div className="h-2 skeleton rounded-md w-16" />
                  </div>
                </div>
                ...
                {/* Price */}
                <div className="h-4 skeleton rounded-md w-20 shrink-0" />
