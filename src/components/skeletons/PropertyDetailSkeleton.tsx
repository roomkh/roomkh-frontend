        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 space-y-6">
          <div className="flex justify-end gap-2">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
             <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-2 h-64 sm:h-80">
               <div className="col-span-1 sm:col-span-2 h-48 sm:h-full bg-gray-200 rounded-2xl" />
